...
def build_model(num_filters, num_classes, sequence_max_length=512, num_quantized_chars=71, 
                embedding_size=16, learning_rate=0.001, top_k=3, model_path=None):
    ...
    for i in range(len(num_filters)):
        conv = ConvBlockLayer(nltk_utils.get_conv_shape(conv), num_filters[i])(conv)
